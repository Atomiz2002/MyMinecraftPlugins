...
public class PoliceOfficer extends EntityZombie {
	...
	private static org.bukkit.inventory.ItemStack[] equip = Settings.getOfficerEquip();
...
//		}
		...
		setCustomName(Settings.getOfficerName());
...
//		goalSelector.a(2, new PathfinderGoalMeleeAttack((EntityCreature) levels.get(levels.size() - 1), 1.0D, false));
		...
		EntityEquipment e = ((Zombie) getBukkitEntity()).getEquipment();
		e.setHelmet(equip[0]);
